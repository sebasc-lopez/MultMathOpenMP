...
double **multiplicar(double **m1, double **m2, int rows, int cols, int sta)
{
    ...
    #pragma omp parallel for private(i,k) schedule(static, sta)
...
int main(int argc, char *argv[])
{
    ...
    double **res = multiplicar(matriz1, matriz2, rows, cols, sta);
